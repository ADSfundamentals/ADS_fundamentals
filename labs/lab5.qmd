...
You will work with the `titanic` data set which you can download [here](../data/titanic.csv), containing information on the fate of passengers on the infamous voyage. 
