...
For the first part of this practical, a [dataset](../data/Fish.csv) from a fish market is used. The variables in this fish data set are:
...
data_fish <- read.csv(here::here("data", "Fish.csv"))
